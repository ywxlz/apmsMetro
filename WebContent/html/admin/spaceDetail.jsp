        	...
        	<table cellspacing="1" cellpadding="4" width="100%" class="tableborder" id="table3">
        		<s:iterator value="#session.map" var="map">
					...
					<tr>
						...
						<td colspan="3" class="altbg2"><div align="center"><s:property value="key.appendix" /></div></td>
					</tr>
					<tr>
						<td class="altbg1"><div align="center">特殊要求</div></td>
						<td colspan="3" class="altbg2"><div align="center"><s:property value="key.remark" /></div></td>
					</tr>

    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="nContainer">                
                <ul class="navigation">         
                    <li class="active"><a href="#" class="blblue">申请单审批</a></li>
                    <li>
        ...
        <div class="body">
        	...
        	<table cellspacing="1" cellpadding="4" width="100%" class="tableborder" id="table3">
				<tr>
					<td colspan="15" class="header">申请单审批</td>
				</tr>
				<tr>
				...
				<s:if test="#session.approvalList == null">
					<tr>
				...
				<s:else>
					<s:iterator value="#session.approvalList" var="request" status="I">
						<s:if test="#I.index % 2 == 1">
							<tr id="odd">
								<td style="background-color: #e6e6fa;" class="altbg2" rowspan="2" align="center"><s:property value="#I.index + 1" /></td>
								<td style="background-color: #e6e6fa;" class="altbg2" rowspan="2" align="center"><s:property value="#session.userList[#I.index].username" /></td>
								...
								<td style="background-color: #e6e6fa;" class="altbg2" rowspan="2" align="center"><a href="requestDetailAction?id=<s:property value="#request.id" />" id="requestDetail">详情</a></td>
							</tr>
						</s:if>
						<s:else>
							<tr id="even">
								<td style="background-color: #fff0fa;" class="altbg2" rowspan="2" align="center"><s:property value="#I.index + 1" /></td>
								<td style="background-color: #fff0fa;" class="altbg2" rowspan="2" align="center"><s:property value="#session.userList[#I.index].username" /></td>
								...
								<td style="background-color: #fff0fa;" class="altbg2" rowspan="2" align="center"><a href="requestDetailAction?id=<s:property value="#request.id" />" id="requestDetail">详情</a></td>
							</tr>
						</s:else>
						<tr></tr>
					</s:iterator>

        	...
        	<table cellspacing="1" cellpadding="4" width="100%" class="tableborder" id="table3">
        		<s:iterator value="#session.map" var="map">
					...
					<tr>
						...
						<td class="altbg2"><div align="center"><s:property value="key.title" /></div></td>
						<td class="altbg1"><div align="center">人员编号</div></td>
						<td class="altbg2"><div align="center"><s:property value="key.assigner" /></div></td>
					</tr>
					<tr>
						<td class="altbg1"><div align="center">联系电话</div></td>
						<td class="altbg2"><div align="center"><s:property value="key.phone" /></div></td>
						<td class="altbg1"><div align="center">申请日期</div></td>
						<td class="altbg2"><div align="center"><s:property value="value.time" /></div></td>
					</tr>
					<tr>
						<td class="altbg1"><div align="center">空间需求</div></td>
						<td class="altbg2"><div align="center"><s:property value="value.interSpace" /></div></td>
					...
					<tr>
						...
						<td class="altbg2"><div align="center"><s:property value="value.username" /></div></td>
					</tr>
					<tr>
